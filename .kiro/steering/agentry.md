# .kiro/steering/agentry.md

<!-- AGENTRY-RUNTIME-CONTEXT:BEGIN -->
_Auto-managed by Agentry on 2026-07-05 for `kiro-cli`. Edit `.agentry/startupcommands.md` or `agent-memory/context/project-context.md`; this block is replaced on CLI launch._
