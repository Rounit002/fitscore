...
## Working Directory
All work should stay within: `D:\NutriScan-mainn`
...
_Auto-managed by Agentry on 2026-07-05 for `claude`. Edit `.agentry/startupcommands.md` or `agent-memory/context/project-context.md`; this block is replaced on CLI launch._
